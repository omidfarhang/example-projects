const NAMESPACE = 'stencil-my-button';
const BUILD = /* stencil-my-button */ { hotModuleReplacement: false, hydratedSelectorName: "hydrated", lazyLoad: true, prop: true, propChangeCallback: false, updatable: true};
