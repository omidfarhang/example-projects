...
export interface StressorBiomeDelta {
  ...
  integrity?: number;
  integrityMin?: number;
  /** Acute immune signaling (histamine, cytokines) — tissue inflammation rises indirectly. */
...
export const STRESSORS: StressorDef[] = [
  ...
  s(
    ...
    { immuneActivity: 0.38, integrity: -0.25, integrityMin: 0.2, commensalVitality: -0.25 },
  ...
  s(
    ...
    { integrity: -0.18, integrityMin: 0.2, moisture: 0.1, moistureMax: 1 },
  ...
  s(
    ...
    { moisture: 0.15, moistureMax: 1, biofilm: 0.2 },
  ...
  s(
    ...
    { integrity: -0.22, integrityMin: 0.2, immuneActivity: 0.15 },
  ...
  s(
    ...
    { moisture: -0.18, moistureMin: 0.12, immuneActivity: 0.28, oxygenation: -0.15, oxygenationMin: 0.2, commensalVitality: -0.18 },
  ),
  s(
    'contact_allergen',
    ...
    { immuneActivity: 0.28, integrity: -0.15, integrityMin: 0.2 },
  ...
  s(
    ...
    { integrity: -0.2, integrityMin: 0.2, immuneActivity: 0.22 },
  ...
  s(
    ...
    { sebum: 0.18, sebumMax: 1, immuneActivity: 0.18, integrity: -0.1, integrityMin: 0.25 },
    undefined,
    'stress',
  ),
  s(
    ...
    { ph: 0.5, phMax: 8, integrity: -0.18, integrityMin: 0.2, immuneActivity: 0.25, commensalVitality: -0.22 },
  ...
  s(
    ...
    { moisture: -0.2, moistureMin: 0.15, immuneActivity: 0.22, integrity: -0.15, integrityMin: 0.2, commensalVitality: -0.12 },
  ),
  s(
    'hard_water_wash',
  ...
  s(
    ...
    { biofilm: 0.28, sebum: 0.15, sebumMax: 1 },
  ...
  s(
    ...
    { immuneActivity: 0.32, commensalVitality: -0.15 },
    undefined,
    'allergen',
  ),
  s(
    ...
    { integrity: -0.12, integrityMin: 0.2, moisture: 0.1, moistureMax: 1, commensalVitality: -0.2 },
  ...
  s(
    ...
    { integrity: -0.15, integrityMin: 0.2, biofilm: 0.2, moisture: 0.08, moistureMax: 1 },
    [
  ...
  s(
    ...
    { moisture: -0.22, moistureMin: 0.12, immuneActivity: 0.30, oxygenation: -0.2, oxygenationMin: 0.25, commensalVitality: -0.25 },
  ),
  s(
    'cold_air_burst',
    'COLD DRY AIR BURST',
  ...
  s(
    ...
    { immuneActivity: 0.28, integrity: -0.14, integrityMin: 0.2, commensalVitality: -0.12 },
  ...
  s(
    ...
    { immuneActivity: 0.30, integrity: -0.12, integrityMin: 0.2, allergenAdhesion: 0.25, allergenAdhesionMax: 1 },
  ...
  s(
    ...
    { immuneActivity: 0.18, integrity: -0.16, integrityMin: 0.2 },
  ...
  s(
    ...
    { moisture: -0.32, moistureMin: 0.08, integrity: -0.14, integrityMin: 0.2 },
  ),
  ...
  s(
    ...
    { ph: -0.6, phMin: 4.5, immuneActivity: 0.24, integrity: -0.14, integrityMin: 0.2 },
    undefined,
    'stress',
  ),
  s(
    ...
    { moisture: -0.2, moistureMin: 0.15, immuneActivity: 0.15, commensalVitality: -0.18 },
  ...
  s(
    ...
    { moisture: -0.28, moistureMin: 0.1, salinity: 0.08, salinityMax: 1 },
  ...
  s(
    ...
    { integrity: -0.12, integrityMin: 0.2, commensalVitality: -0.2 },
    [{ type: 'yeast', strain: 'C. albicans', count: 10 }],
    'stress',
  ),
  s(
  ...
  s(
    ...
    { immuneActivity: 0.22, integrity: -0.25, integrityMin: 0.15, commensalVitality: -0.2 },
    [
  ...
  s(
    ...
    { moisture: 0.22, moistureMax: 1, sugarLoad: 0.2, sugarLoadMax: 1, biofilm: 0.25 },
  ...
  s(
    ...
    { sebum: 0.2, sebumMax: 1, moisture: 0.1, moistureMax: 1, sugarLoad: 0.15, sugarLoadMax: 1 },
  ),
  ...
  s(
    ...
    { ph: 0.6, phMax: 6.8, moisture: 0.15, moistureMax: 1 },
  ...
  s(
    ...
    { immuneActivity: 0.22, integrity: -0.16, integrityMin: 0.2, commensalVitality: -0.12 },
    [{ type: 'allergen', strain: 'irritant', count: 12, fromAbove: true }],
    'allergen',
  ),
  s(
  ...
  s(
    ...
    { integrity: -0.2, integrityMin: 0.2, immuneActivity: 0.24, commensalVitality: -0.25, probioticVitality: -0.2 },
    [{ type: 'allergen', strain: 'irritant', count: 8, fromAbove: true }],
    'allergen',
  ),
  ...
  s(
    ...
    { integrity: -0.15, integrityMin: 0.3, immuneActivity: 0.14 },
    undefined,
    'stress',
  ),
  s(
    ...
    ['gut'],
    ['Enteropathogen bloom — pathogen pressure rising'],
    {},
  ...
  s(
    ...
    { immuneActivity: 0.12, integrity: -0.08, integrityMin: 0.25, ph: 0.15, phMax: 7.0 },
  ),
  s(
    'food_poisoning',
    'FOOD POISONING',
    ...
    { integrity: -0.2, integrityMin: 0.2 },
  ...
  s(
    ...
    { integrity: -0.22, integrityMin: 0.2, immuneActivity: 0.22, commensalVitality: -0.25, postbioticLevel: -0.15, postbioticMin: 0 },
    undefined,
    'stress',
  ),
  s(
    ...
    { integrity: -0.25, integrityMin: 0.2, immuneActivity: 0.26 },
    undefined,
    'stress',
  ),
  s(
    ...
    { immuneActivity: 0.28, integrity: -0.12, integrityMin: 0.25 },
  ...
  s(
    ...
    { integrity: -0.18, integrityMin: 0.2, immuneActivity: 0.16, commensalVitality: -0.15 },
  ),
  s(
    'sleep_deprivation',
    'SLEEP DEPRIVATION',
    ...
    { integrity: -0.12, integrityMin: 0.25, immuneActivity: 0.12, commensalVitality: -0.1 },
    undefined,
    'stress',
  ),
  s(
    ...
    { integrity: -0.18, integrityMin: 0.2, immuneActivity: 0.18, moisture: -0.15, moistureMin: 0.35 },
  ...
  s(
    ...
    { sugarLoad: 0.5, sugarLoadMax: 1, postbioticLevel: -0.12, postbioticMin: 0 },
  ),
  s(
    'intense_exercise',
    ...
    { integrity: -0.14, integrityMin: 0.25, moisture: -0.08, moistureMin: 0.4 },
    undefined,
    'stress',
  ),
  s(
    ...
    { integrity: -0.16, integrityMin: 0.2, moisture: -0.1, moistureMin: 0.35 },
  ...
  s(
    ...
    { immuneActivity: 0.28, integrity: -0.1, integrityMin: 0.25 },
