...
export const PRODUCTS: Record<ProductId, ProductDef> = {
  ...
  oral_probiotic_lozenge: {
    ...
    effects: { biofilm: -0.15, moisture: 0.12, integrity: 0.08 },
  ...
  vaginal_probiotic_capsule: {
    ...
    why: 'Vaginal capsule seeds acidophilus/rhamnosus/reuteri — acidifies mucosa and restores barrier after alkaline stress.',
    strains: [
      { id: 'lacid', dose: 0.85 },
      { id: 'lrham', dose: 0.75 },
      { id: 'lreuteri', dose: 0.7 },
    ],
    effects: { ph: -0.35, phMin: 3.8, integrity: 0.08 },
  ...
  probiotic_topical_cream: {
    ...
    effects: { ph: -0.2, phMin: 4.5, biofilm: -0.12, moisture: 0.08 },
  ...
  kimchi: {
    ...
    why: 'Fermented vegetables deliver L. plantarum plus inulin fiber — acidifies gut and feeds SCFA production.',
    strains: [
      { id: 'lplant', dose: 0.9 },
      { id: 'lcasei', dose: 0.55 },
      { id: 'lsaliv', dose: 0.35 },
    ...
    effects: { ph: -0.22, phMin: 5.2, postbioticLevel: 0.06 },
