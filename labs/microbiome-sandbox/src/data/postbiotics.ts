...
export const POSTBIOTICS: Record<PostbioticId, PostbioticDef> = {
  scfa_mix: {
    ...
    effects: { postbioticLevel: 0.3, integrity: 0.12, immuneActivity: -0.05 },
    why: 'Mixed SCFA metabolites from fermentation — integrity recovers and immune signaling calms across gut mucosa.',
  ...
  butyrate: {
    ...
    effects: { postbioticLevel: 0.25, integrity: 0.18, immuneActivity: -0.04 },
  ...
  propionate: {
    ...
    effects: { postbioticLevel: 0.15, commensalVitality: 0.1, immuneActivity: -0.03 },
    why: 'Propionate modulates liver metabolism and nourishes commensal neighbors — mild immune-calming effect.',
    preferredRegions: ['gut'],
    preferredMultiplier: 1,
