  ...
  return `
        <section class="bd-viewport-wrap">
          <div class="bd-viewport" data-viewport role="img" aria-label="${t('viewport.fullBodyTitle')}">
            ...
            <div class="bd-tissue-dock" data-tissue-dock hidden>
              <aside class="bd-tissue-guide" data-tissue-guide aria-label="${t('viewport.tissueGuideTitle')}">
              ...
              <div class="bd-legend-box" data-legend-box></div>
            </div>
